...
# Try to read the actual memory_record_id (which includes the API-generated suffix)
...
if [ -z "$MEMORY_ID" ]; then
    ...
    print_warning "Could not read memory record ID from $MEMORY_RECORD_FILE, using constructed ID: $MEMORY_ID"
fi
