...
SUPPLY_VENDORS = ["Goliath AdX", "Magnetar", "PubMatrix", "OrbitX", "Apex Exchange", "Zephyr", "Nimbus TAM", "SpectraX", "FluxWheel"]
SITES = ["claritynews.com", "sportspulse.com", "skycast.com", "metrotimes.com", "falconnews.com", "novabroadcast.com", "nationdaily.com", "capitolpress.com", "globalrelay.com", "thesentinel.com"]
APPS = ["ClarityNews App", "SportsPulse App", "SkyCast Channel", "MetroTimes App", "Falcon News App", "Nova Broadcast News", "Nation Daily", "CapPress App", "Global Relay News", "Sentinel"]
...
VIEWABILITY_VENDORS = ["AdShield", "DualCheck", "Beacon", "CoreMetric"]
